...
Original file is located at
    https://colab.research.google.com/drive/1lK7bM9weaT26aGFkkjkRKXl4ZWbYNOOw
"""
...
# Load a subset of WikiText (as DailyDialog's script is no longer supported)
...
def tokenize_function(examples):
    # For wikitext, we use the 'text' field
